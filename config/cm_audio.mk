...
ALARM_PATH := vendor/dos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/dos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/dos/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/dos/prebuilt/common/media/audio/ui
