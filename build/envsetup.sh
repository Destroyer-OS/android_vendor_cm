...
function breakfast()
{
    ...
    for f in `/bin/ls vendor/dos/vendorsetup.sh 2> /dev/null`
        do
            echo "including $f"
            . $f
        done
